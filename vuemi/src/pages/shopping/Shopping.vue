  ...
  <div>
                ...
                <div class="cart-tab-5">
                  <div class="cart-item-opration">
                    <a href="javascript:;" class="item-edit-btn" >
                      <svg class="icon icon-del" @click="del">
          ...
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              <div class="item-total">
                Item total: <span class="total-price">总价</span>
              </div>
              <div class="btn-wrap">
                <router-link
                to="/order/address"
                class="btn btn--red">去支付</router-link>
              </div>
            </div>
          </div>
        </div>
    ...
    <Modal :mdShow="modalConfirm" >
      ...
      <div slot="btnGroup">
        ...
        <a class="btn btn--m btn--red" href="javascript:;" @click="canel">关闭</a>
      </div>
    </Modal>
